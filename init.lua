...
require('lazy').setup({
...

  {
    ...
    init = function()
      ...
      vim.g.vimtex_quickfix_autoclose_enabled = 1 -- Automatically close the quickfix window if there are no errors/warnings
      -- Enable folding based on LaTeX structure
